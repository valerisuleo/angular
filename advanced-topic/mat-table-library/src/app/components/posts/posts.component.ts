...
export class PostsComponent implements OnInit {
    ...
    public columns: string[] = ['userId', 'title', 'id', 'body'];
    ...
    private getPosts(): void {
        this.service
            ...
            .subscribe((response: IPost[]) => {
                this.dataSource = this.createCell(Object.keys(response[0]), response, this.setCellProperty);
            })
    }
    ...
    public handleSort(data): void {
        ...
        dataSource.sortingDataAccessor = (item, property) => {
            switch (property) {
                ...
                case 'body': return item['body'].value;
